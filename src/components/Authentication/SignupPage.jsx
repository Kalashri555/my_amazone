...
const SignupPage = () => {
    ...
    return (
        <section className='align_center form_page'>
            <form className='authentication_form signup_form' onSubmit=
            {handleSubmit(onSubmit)}>
                ...
                <div className='image_input_section'>
                    ...
                    <input type='file' onChange={e => setProfilePic(e.target.
                        files[0])}
                ...
                <div className='form_inputs signup_form_input'>
                    <div>
                        ...
                        <input
                            ...
                            {...register("name")}
                        />
                        {errors.name && <em className="form_error">
                    ...
                    <div>
                        ...
                        {errors.confirmPassword && <em className="form_error">
                            {errors.confirmPassword.message}</em>}
                    </div>
                    ...
                    <div className='signup_textares_section'>
                        ...
                        />
                        {errors.deliveryAddress && <em className="form_error">
                            {errors.deliveryAddress.message}</em>}
                    </div>
                </div>
